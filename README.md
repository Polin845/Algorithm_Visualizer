...
- ![Видеодемонстрация](docs/video-demo.mp4)
- ![Стейкхолдеры](docs/Сегментация%20стейкхолдеров%20(ЦА).pdf)
- ![ФТ](docs/Функциональные%20требования.pdf)
! ![Конкуренты](docs/Конкуренты.pdf)
...
graph TD
    ...
    N --> I
    N --> K
    F --> O[Структуры данных structures.js]  // Для графов, очередей и т.д.
    F --> P[Данные графа graph-data.js]  // Для предопределённых примеров
```
